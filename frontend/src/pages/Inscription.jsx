          ...
          <div className="col-12 col-md-8 col-lg-6">
            ...
            <div className="bg-white rounded-4 shadow-lg border" style={{ 
              ...
              <form onSubmit={handleSubmit}>
                ...
                {/* Message de succès Amazon-like - supprimé car redirection vers page dédiée */}
                {false && (
                  <div className="animate__animated animate__fadeIn text-center py-5">
                    ...
                    <h4 className="fw-bold mt-3 mb-2" style={{ color: '#232f3e' }}>
                      Votre compte a bien été créé !
                    </h4>
                    <p className="text-muted mb-4" style={{ fontSize: '16px' }}>
                      Vous pouvez maintenant vous connecter et profiter de tous les avantages VenteChaussure.
                    </p>
                    <Link to="/connexion" className="btn fw-bold px-4 py-2" style={{
                      background: 'linear-gradient(135deg, #e47911 0%, #f0c14b 100%)',
                      border: 'none',
                      color: '#232f3e',
                      borderRadius: '8px',
