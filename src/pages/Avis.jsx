    ...
    <>
      ...
      <div className="container-fluid py-4">
        <h1 className="mb-4 text-warning fw-bold" style={{fontSize: '2.2rem'}}>
          ...
          {t("my_reviews_by_product")}
        </h1>

        {avisList.length === 0 && (
          <div className="text-center py-5">
            <i className="bi bi-star display-1 text-muted mb-3"></i>
            <h4 className="text-muted">{t("no_reviews_yet")}</h4>
            <p className="text-muted">{t("leave_review_from_orders_page")}</p>
          </div>
        )}
                ...
                <div className="card-body p-4">
                  <div className="d-flex align-items-center mb-3">
                    ...
                    <div>
                      ...
                      <div className="text-muted small">{t("order")} {avis.commandeId} • {new Date(avis.date).toLocaleDateString('fr-FR')}</div>
                    </div>
                  </div>
                  <div className="mb-2">
                    {[...Array(5)].map((_, i) => (
