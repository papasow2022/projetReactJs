...
import { createGiftCard } from '../utils/giftCards';
...
export default function CartesCadeaux() {
  ...
  function handleAchat(e) {
    ...
    if (deliveryMethod === 'email' && deliveryAddress) {
      setConfirmation(`Carte cadeau créée et envoyée par email à ${deliveryAddress}. Code: ${card.code} (${montant} ${getCurrencySymbol(giftCardCurrency)})`);
